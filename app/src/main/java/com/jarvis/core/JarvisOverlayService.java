...
public class JarvisOverlayService extends Service implements TextToSpeech.OnInitListener {
        ...
        handler.post(() -> {
            if (SpeechRecognizer.isRecognitionAvailable(this)) {
                ...
                speechRecognizer.setRecognitionListener(new RecognitionListener() {
                    @Override public void onReadyForSpeech(Bundle params) { showBubble("Sun rahi hoon, boliye... 🎙️"); }
                    @Override public void onBeginningOfSpeech() {}
                    @Override public void onRmsChanged(float rmsdB) {}
                    @Override public void onBufferReceived(byte[] buffer) {}
                    @Override public void onEndOfSpeech() { showBubble("Processing... ⏳"); }
                    @Override public void onError(int error) { showBubble("Aawaz saaf nahi aayi!"); }
                    ...
                    public void onResults(Bundle results) {
                        ...
                        if (matches != null && !matches.isEmpty()) {
                            ...
                            showBubble("Aapne kaha: " + spokenText);
                            fetchDeepAIResponse(spokenText);
                        }
                    }
    ...
    private void buildHudPanel() {
        ...
        micBtn.setText("🎙️");
        micBtn.setBackground(createRoundedBackground("#FFB703", "#FFFFFF", 12f, 0));
        ...
        networkPool.execute(() -> {
            ...
            try {
                ...
                if (conn.getResponseCode() == 200) {
                    ...
                    responseText = "Bilkul bhai! Main ready hu, bolo aage kya karna hai?";
                }
            } catch (Exception e) {
                responseText = "Bhai network check kar, baaki systems online hain!";
            }
    ...
    private void toggleFlashlight() {
        try {
            if (cameraId != null && cameraManager != null) {
                ...
                String msg = isFlashlightOn ? "Flashlight on!" : "Flashlight off!";
                showBubble(msg);
                speakNaturally(msg);
            }
